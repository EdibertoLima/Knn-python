# -*- coding: utf-8 -*-
"""
Created on Mon Jan 21 21:11:04 2019
...
path='C:\Aquisição\Renomeado' #Confgurar caminho para pasta contendo as amostras

Files=getListOfFiles(path);  

amostra=np.empty((100000,5), float);
...
x_array=[2,3] #Configurar quantas amostras devem ser "saltadas" para subamostragem
...
for x_idx in range(0,len(x_array)):
    ...
    #####################################################################################
        ...
        output = signal.filtfilt(b, a, amostra[:,1])
        ...
        DataBase[i,nCols-3:]= [Freq, Load, Classe]
